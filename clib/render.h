...
enum TEXTURE_PARAM {
	...
	TEXTURE_LINEAR = 0,	// default
	TEXTURE_NEAREST = 1,

	TEXTURE_CLAMP_TO_EDGE = 0,	// default
	TEXTURE_REPEAT = 1,
...
void render_texture_setparam(struct render *R, RID id, enum TEXTURE_PARAM what, enum TEXTURE_PARAM value);
